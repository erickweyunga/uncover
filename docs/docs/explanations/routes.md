...
As your API grows, organizing routes becomes important for maintainability.

### By Resource

Group endpoints by the resource they handle:
...
For complex applications, organize by feature rather than resource:
...
Choose the structure that makes sense for your application. There's no single right answer.
